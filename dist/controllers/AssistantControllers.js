...
exports.getAllVoices = exports.deleteVoice = exports.getVoiceById = exports.updateVoice = exports.createVoice = void 0;
...
const updateVoice = async (req, res) => {
    try {
        ...
        const updatedVoice = await Voice_1.default.findByIdAndUpdate(id, { $set: updates }, { new: true, runValidators: true });
        if (!updatedVoice) {
