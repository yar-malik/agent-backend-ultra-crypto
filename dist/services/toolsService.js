...
toolsApi.interceptors.response.use(response => {
    ...
    console.error('Request failed:', {
        ...
        config: {
            ...
            headers: (_d = error.config) === null || _d === void 0 ? void 0 : _d.headers
        }
    });
...
exports.toolsService = {
    async createTool(toolData) {
        ...
        try {
            const formattedName = toolData.name.replace(/\s+/g, '_').replace(/[^a-zA-Z0-9_-]/g, '');
            ...
            console.log('Sending exact matching payload:', JSON.stringify(payload, null, 2));
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                console.error('API Error:', {
                    ...
                    config: {
                        url: `${(_c = error.config) === null || _c === void 0 ? void 0 : _c.baseURL}${(_d = error.config) === null || _d === void 0 ? void 0 : _d.url}`,
                        method: (_e = error.config) === null || _e === void 0 ? void 0 : _e.method,
                        headers: (_f = error.config) === null || _f === void 0 ? void 0 : _f.headers,
                        data: JSON.parse(((_g = error.config) === null || _g === void 0 ? void 0 : _g.data) || '{}')
                    }
                });
                throw new AppError_1.AppError('Failed to create tool. Please try again.', ((_h = error.response) === null || _h === void 0 ? void 0 : _h.status) || 500);
            }
            throw error;
        }
    },
    async getAllTools() {
        ...
        try {
            ...
            const tools = await Tool_1.Tool.insertMany(response.data.results.map((toolData) => ({
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                throw new AppError_1.AppError(((_d = (_c = error.response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.message) || 'Failed to fetch tools', ((_e = error.response) === null || _e === void 0 ? void 0 : _e.status) || 500);
            }
            throw error;
        }
    },
    async getTool(toolId) {
        ...
        try {
            ...
            const updatedTool = await Tool_1.Tool.findOneAndUpdate({ toolId }, {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                throw new AppError_1.AppError(((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) === 404 ? 'Tool not found' : 'Failed to fetch tool', ((_d = error.response) === null || _d === void 0 ? void 0 : _d.status) || 500);
            }
    ...
    async updateTool(toolId, toolData) {
        ...
        try {
            ...
            const response = await toolsApi.put(`/api/tools/${toolId}`, {
                name: toolData.name,
                definition: {
                    modelToolName: ((_a = toolData.definition) === null || _a === void 0 ? void 0 : _a.modelToolName) || localTool.definition.modelToolName,
                    description: ((_b = toolData.definition) === null || _b === void 0 ? void 0 : _b.description) || localTool.definition.description,
                    requirements: {
                        httpSecurityOptions: {
                            options: [{}]
                        }
                    ...
                    http: {
                        baseUrlPattern: ((_d = (_c = toolData.definition) === null || _c === void 0 ? void 0 : _c.http) === null || _d === void 0 ? void 0 : _d.baseUrlPattern) || localTool.definition.http.baseUrlPattern,
                        httpMethod: ((_f = (_e = toolData.definition) === null || _e === void 0 ? void 0 : _e.http) === null || _f === void 0 ? void 0 : _f.httpMethod) || localTool.definition.http.httpMethod
                    },
                    timeout: ((_g = toolData.definition) === null || _g === void 0 ? void 0 : _g.timeout) || localTool.definition.timeout
                }
            });
            if (!response.data) {
            ...
            if (axios_1.default.isAxiosError(error)) {
                console.error('API Error:', {
                    ...
                    data: (_j = error.response) === null || _j === void 0 ? void 0 : _j.data,
                    toolId,
                    requestData: toolData
                });
                throw new AppError_1.AppError(((_k = error.response) === null || _k === void 0 ? void 0 : _k.status) === 404 ? 'Tool not found' : 'Failed to update tool', ((_l = error.response) === null || _l === void 0 ? void 0 : _l.status) || 500);
            }
            console.error('Unexpected error:', error);
            throw error;
        }
    ...
    async deleteTool(toolId) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                throw new AppError_1.AppError(((_c = error.response) === null || _c === void 0 ? void 0 : _c.status) === 404 ? 'Tool not found' : 'Failed to delete tool', ((_d = error.response) === null || _d === void 0 ? void 0 : _d.status) || 500);
            }
            throw error;
        }
    }
